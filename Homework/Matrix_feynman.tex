...
\vertex[right = 2cm of q2](q3);
\diagram*{
(q)--[fermion, edge label=$e^-$](q2)--[photon, edge label=$\gamma$](q1);
(q3)--[fermion, edge label=$e^-$](q5);
(q3)--[photon, edge label=$\gamma$](q4);
...
\vertex[right = 2cm of q2](q3);
\diagram*{
(q1)--[fermion, edge label=$e^+$](q2)--[photon, edge label=$\gamma$](q);
(q3)--[fermion, edge label=$e^+$](q4);
(q3)--[photon, edge label=$\gamma$](q5);
(q2)--[fermion, edge label=$e^+$](q3);
};
\end{feynman}
